...
const services: Array<{ title: string; description: string; icon: LucideIcon; to: string }> = [
  ...
  { title: "Rural Tech Store", description: "Provide access to digital and technology-enabled business opportunities designed around different participation models.", icon: Store, to: "/services/rural-tech-store" },
