...
function TermsAndConditions() {
  return <LegalPage title="Terms & Conditions" description="Terms governing access to and use of the Samrik Solutions website.">
    ...
    <LegalSection title="Services Information"><p>Information about SaaS Services, Logistic Services, Educational Services, Rural Tech Store Services, and other services is provided for general informational and business purposes. The scope, pricing, deliverables, and obligations for a specific engagement are established separately where applicable.</p></LegalSection>
