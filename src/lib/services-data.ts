...
export const serviceDetails = {
  ...
  "customer-support": {
    ...
    subheading: "Reliable Support for Every Customer Interaction",
    paragraphs: [
      "Samrik Solutions provides customer support services that help businesses stay responsive and consistent across every customer interaction. Our teams work with your product information, support processes, and communication guidelines to represent your brand professionally.",
      "Whether you need voice support, chat assistance, or email-based customer care, we design the support process around your business requirements and customer experience goals.",
    ],
    ctaPrimary: { label: "Discuss Your Support Requirements", to: "/contact" },
    ctaSecondary: { label: "Partner With Us", to: "/partner" },
    right: {
      type: "checklist",
      title: "What we can support",
  ...
  "mail-support": {
    slug: "mail-support",
    icon: Mail,
    title: "Mail Support Services",
    eyebrow: "Support service 06",
    description:
    ...
    subheading: "Professional Email Communication, Handled Consistently",
    paragraphs: [
      "Our mail support services help businesses manage customer and business email communication with accuracy and consistency. Trained teams handle incoming enquiries, responses, and follow-ups using structured email workflows aligned with your communication standards.",
      "From customer enquiries to ongoing correspondence, we ensure every email is handled professionally, on time, and in line with your brand voice.",
    ],
    ctaPrimary: { label: "Discuss Your Mail Support Needs", to: "/contact" },
    ctaSecondary: { label: "Partner With Us", to: "/partner" },
    right: {
      type: "checklist",
      title: "What we can support",
      items: [
        ...
        "Template & guideline-based responses",
        "Escalation handling",
        "Inbox organization",
  ...
  "data-entry": {
    ...
    eyebrow: "Support service 07",
    description:
      "Accurate data entry and processing support that keeps your business information organized, up to date, and ready to use.",
    subheading: "Accurate Data, Organized Operations",
    paragraphs: [
      "Samrik Solutions provides data entry and processing services that help businesses keep their information accurate, organized, and accessible. Our teams follow defined quality-check processes to maintain consistency across every record.",
      "From routine data entry to structured data processing tasks, we support your back-office operations so your team can focus on core business activities.",
    ],
    ctaPrimary: { label: "Discuss Your Data Entry Needs", to: "/contact" },
    ctaSecondary: { label: "Partner With Us", to: "/partner" },
    right: {
      type: "checklist",
      title: "What we can support",
