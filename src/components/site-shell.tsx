    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <footer className="bg-hero text-hero-foreground">
        <div className="section-shell grid gap-10 py-16 md:grid-cols-2 lg:grid-cols-4">
          ...
          <FooterList title="Services" items={[...services.map((item) => ({ label: item.title, to: `/services/${item.slug}` })), { label: "Lead Generation", to: "/services" }, { label: "Business Development", to: "/services" }, { label: "Customer Support", to: "/services/customer-support" }, { label: "Mail Support", to: "/services/mail-support" }, { label: "Data Entry", to: "/services/data-entry" }]} />
